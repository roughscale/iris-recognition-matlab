function pbsNonSharedParallelSubmitFcn(scheduler, job, props, ...
                                        timeLimit, eMail, clusterHost, remoteDataLocation)
...
localScript = createPBSSubmitScript(commandToRun, decodeFcn, ...
    props.StorageConstructor, remoteDataLocation, timeLimit, eMail, jobLocation, ...
...
function filename = createPBSSubmitScript(commandToRun, decodeFunction, ...
        storageConstructor, remoteDataLocation, timeLimit, eMail, jobLocation, ...
...
setEnv = sprintf([ ...
    ...
    ':ppn=', num2str(procsPerNode), '\n', ...
    '#PBS -W x=GRES:MATLAB_Distrib_Comp_Engine+', num2str(numberOfTasks), '\n', ...
