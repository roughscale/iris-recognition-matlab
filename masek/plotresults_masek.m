function plotresults_masek
  ...
  print -dpng masek-hd-genuine.png

  % Plot 2: Imposter Matches
  % Load imposter match data
  load('masek_results.mat','imp');

  % Create x-axis
  %x = 0:0.001:1.0;
  % use incorrect generate x-axis for imp matrix
  x = 0:0.001:0.999;
  ...
  print -dpng masek-hd-imposter.png
  ...
  print -dpng masek-hd-genuine-same.png

  %Plot 4: Genuine Different Eye Only

  %function plot_masek_genuine_diff
  %load('masek_gen_results.mat','diff');
  x = 0:0.001:1.0;
  ...
  print -dpng masek-hd-genuine-diff.png
